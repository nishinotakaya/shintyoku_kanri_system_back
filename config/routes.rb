  ...
  namespace :api do
    namespace :v1 do
      ...
      namespace :admin do
        ...
        delete "impersonations", to: "impersonations#destroy"
      end
      ...
      resources :business_expenses, only: [ :index, :create, :update, :destroy ] do
        ...
        collection do
          ...
          get  :freee_wallet_txns  # freee「自動で経理」: 未処理明細+AI判定の科目
          post :report_bulk_to_freee # 選択した経費のうちfreee未連携分を一括計上
          post :classify_uncategorized # 未分類の経費をAIでまとめて仕訳
      ...
      post  "backlog_activities/wbs_excel_import", to: "backlog_activities#wbs_excel_import"
