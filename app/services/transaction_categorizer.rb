...
class TransactionCategorizer
  ...
  SYSTEM_PROMPT = <<~SYS.freeze
    ...
    【勘定科目リスト】#{BusinessExpense::ACCOUNT_CATEGORIES.join(" / ")}
    【目安】AWS/GitHub/サーバー/携帯キャリア/プロバイダ→通信費、Amazon/ヨドバシ等の物品→消耗品費、書店/Kindle→新聞図書費、飲食店→接待交際費(取引先)or会議費(カフェ少額)、交通系IC/鉄道/タクシー→旅費交通費、振込手数料/ATM→支払手数料、ガソリン→車両費、セミナー/勉強会/オンライン講座(Peatix・connpass・Udemy等)→研修費。
